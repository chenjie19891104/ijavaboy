...
import demo.cluster.handler.client.OnLogoutHandler;
import demo.cluster.handler.client.OnPublicMessageHandler;
import demo.cluster.handler.cluster.OnLoginClusterHandler;
import demo.cluster.handler.cluster.OnLogoutClusterHandler;
import demo.cluster.handler.cluster.OnPublicMessageClusterHandler;
...
//	}
	...
	private void registSystemEventHandlers() {
		...
		this.addEventHandler(SFSEventType.USER_LOGIN, OnLoginHandler.class);
		this.addEventHandler(SFSEventType.USER_LOGOUT, OnLogoutHandler.class);
		this.addEventHandler(SFSEventType.USER_DISCONNECT, OnLogoutHandler.class);
		this.addEventHandler(SFSEventType.PUBLIC_MESSAGE, OnPublicMessageHandler.class);
	...
	private void registClusterEventHandlers() {
		...
		clusterEventHandler.addClusterEventHandler(ClusterEvent.ON_USER_LOGOUT,new OnLogoutClusterHandler(this));
		clusterEventHandler.addClusterEventHandler(ClusterEvent.ON_PUBLIC_MESSAGE, new OnPublicMessageClusterHandler(this));
