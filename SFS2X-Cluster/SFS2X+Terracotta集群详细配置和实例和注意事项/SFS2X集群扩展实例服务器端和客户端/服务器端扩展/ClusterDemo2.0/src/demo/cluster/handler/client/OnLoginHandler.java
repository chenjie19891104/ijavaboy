...
//		Thread.currentThread().setContextClassLoader(extensionLoader);
		...
		user.setNodeId(extention.getNodeId());
		...
		instance.addUserToCluster(username, user);
//		try {
...
//		}
		...
		//向所有节点发送集群事件
		instance.dispatchClusterEventToAll(clusterEvent, extention.getNodeId());
//		List<String> allNodes = instance.getAllClusteredNodes(extention.getNodeId());
//		
